          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-yellow-50 rounded-lg shadow-lg p-8 text-center hover:shadow-xl transition-shadow duration-300">
              ...
              <Link
                ...
                className="block w-full h-16 flex items-center justify-center rounded-full font-semibold transition-all duration-200 bg-yellow-600 text-white hover:bg-yellow-700 transform hover:scale-105 text-sm leading-tight"
              >
                Apply to<br />Sponsor
              </Link>
            </div>
